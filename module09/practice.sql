...
-- deleting the employees & departments table
...
SELECT department_name, round(avg(salary)) as average_salary from employees join departments using(department_id) GROUP BY department_name ORDER BY average_salary DESC LIMIT 1;
